...
{
    /**
     * Renderiza a lista com as opções de serviços disponives para associação por meio de checkbox.
    ...
    /**
     * Renderiz a lista HTML não ordenada dos serviços associados à unidade, quando for o caso.
     * @param array | null $existingServicesIds
     * @return string
     */
