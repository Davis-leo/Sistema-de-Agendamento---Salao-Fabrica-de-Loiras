<div class="row">
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="name" value="<?php echo old('name', $service->name); ?>" id="name"
    ...
    <div class="col-md-12 mb-3 mt-4">
        ...
        <div class="custom-control custom-checkbox">
            ...
            <input type="checkbox" name="active" value="1" <?php if ($service->active): ?> checked <?php endif; ?>
