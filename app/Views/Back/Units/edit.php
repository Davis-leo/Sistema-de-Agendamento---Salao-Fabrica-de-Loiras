        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="name" value="<?php echo old('name', $unit->name); ?>"
                        id="name" aria-describedby="nameHelp" placeholder="Nome">
                    <?php echo show_error_input('name') ?>
                </div>
                <div class="form-group col-md-4">
                    <label for="phone">Telefone</label>
                    <input type="tel" class="form-control" name="phone"
                        value="<?php echo old('phone', $unit->phone); ?>" id="phone" aria-describedby="phoneHelp"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="time" class="form-control" name="starttime"
                        value="<?php echo old('starttime', $unit->starttime); ?>" id="starttime"
                        aria-describedby="starttimeHelp" placeholder="início expediente">
                    <?php echo show_error_input('starttime') ?>
                </div>
                <div class="form-group col-md-4">
                    <label for="endtime">Fim do Expediente</label>
                    <input type="time" class="form-control" name="endtime"
                        value="<?php echo old('endtime', $unit->endtime); ?>" id="endtime"
                        aria-describedby="endtimeHelp" placeholder="fim expediente">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" class="form-control" name="email"
                        value="<?php echo old('email', $unit->email); ?>" id="email" aria-describedby="emailHelp"
                        placeholder="E-mail">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="address"
                        value="<?php echo old('address', $unit->address); ?>" id="address"
                        aria-describedby="addressHelp" placeholder="Endereço">
