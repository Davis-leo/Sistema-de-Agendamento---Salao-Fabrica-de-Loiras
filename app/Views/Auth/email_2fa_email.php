                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px; background-color:#ffffff; border:1px solid rgba(82,59,49,.14);">
                    <tr>
                        <td style="padding:28px 36px; background-color:#332925;">
                            ...
                            <p style="margin:12px 0 0; color:#fff9f3; font-family:Georgia, 'Times New Roman', serif; font-size:27px; line-height:1.2; font-weight:bold;">Seu acesso está quase pronto.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:40px 36px 16px;">
                            <p style="margin:0 0 10px; color:#914646; font-size:12px; font-weight:bold; letter-spacing:1px; text-transform:uppercase;">Confirmação de segurança</p>
                            <h1 style="margin:0; color:#2e2927; font-family:Georgia, 'Times New Roman', serif; font-size:30px; line-height:1.2; font-weight:bold;">Confirme seu acesso.</h1>
                            <p style="margin:16px 0 0; color:#766d68; font-size:16px; line-height:1.6;">Use o código abaixo para concluir sua entrada na plataforma. Ele é válido apenas para esta tentativa de acesso.</p>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border:1px solid rgba(184,92,91,.25); border-left:4px solid #b85c5b; background-color:#fbf7f2;">
                                <tr>
                                    <td align="center" style="padding:24px 22px;">
                                        <p style="margin:0 0 10px; color:#766d68; font-size:12px; font-weight:bold; letter-spacing:1px; text-transform:uppercase;">Seu código de confirmação</p>
                    ...
                    <tr>
                        <td style="padding:0 36px 36px;">
                            <p style="margin:0 0 16px; color:#2e2927; font-size:15px; font-weight:bold;">Detalhes desta tentativa</p>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid rgba(82,59,49,.14);">
                                ...
                                <tr>
                                    <td style="padding:12px 10px 12px 0; color:#766d68; font-size:13px; border-bottom:1px solid rgba(82,59,49,.14);">Dispositivo</td>
                    ...
                    <tr>
                        <td style="padding:22px 36px; background-color:#f1e7dc; border-top:1px solid rgba(82,59,49,.14);">
                            <p style="margin:0; color:#766d68; font-size:13px; line-height:1.6;">Se você não tentou acessar sua conta, ignore este e-mail e altere sua senha por segurança.</p>
                        </td>
                    </tr>
                </table>
